...
describe('el locale', function() {
  context('with `format`', function() {
    ...
    it('era', function() {
      var result = format(date, 'G, GGGG, GGGGG', {
        locale: locale
      })
    ...
    describe('quarter', function() {
      it('formatting quarter', function() {
        ...
        assert(result === "2ο τρίμηνο, Τ2, 2ο τρίμηνο, β'")
      })
    ...
    describe('month', function() {
      it('formatting month', function() {
        var result = format(date, "do 'του' MMMM", {
          locale: locale
        })
    ...
    describe('week', function() {
      it('ordinal local week of year', function() {
        ...
        var result = format(date, "wo 'εβδομάδα'", {
          locale: locale
        })
      ...
      it('ordinal ISO week of year', function() {
        var date = new Date(1986, 3 /* Apr */, 6)
        var result = format(date, "Io 'ISO εβδομάδα'", {
          locale: locale
        })
    ...
    describe('day', function() {
      it('ordinal date', function() {
        var result = format(date, "'σήμερα είναι η' do", {
          locale: locale
        })
      ...
      it('ordinal day of year', function() {
        var result = format(date, "Do 'ημέρα του χρόνου'", {
          locale: locale
        })
    ...
    describe('week day', function() {
      it('day of week', function() {
        var result = format(date, 'E, EEEE, EEEEE, EEEEEE', {
          locale: locale
        })
        assert(result === 'Σαβ, Σάββατο, Σ, Σα')
      })
    ...
    describe('day period and hour', function() {
      ...
      it('AM, PM', function() {
        var result = format(date, 'h a, h aaaa, haaaaa', {
          locale: locale
        })
    ...
    it('ordinal minute', function() {
      var result = format(date, "mo 'λεπτό'", {
        locale: locale
      })
    ...
    it('ordinal second', function() {
      var result = format(date, "so 'δευτερόλεπτο'", {
        locale: locale
      })
    ...
    describe('long format', function() {
      ...
      it('short date + time', function() {
        ...
        assert(result === '05/04/1986, 10:32 π.μ.')
      })
      ...
      it('long date + time', function() {
        ...
        assert(result === '5 Απριλίου 1986 στις 10:32 π.μ.')
      })
      ...
      it('full date + time', function() {
        ...
        assert(result === 'Σάββατο, 5 Απριλίου 1986 στις 10:32 π.μ.')
      })
    })
  })
  ...
  context('with `formatRelative`', function() {
    ...
    it('today', function() {
      ...
      assert(result === 'σήμερα στις 04:50 μ.μ.')
    })
    ...
    it('tomorrow', function() {
      ...
      assert(result === 'αύριο στις 07:30 π.μ.')
    })
  ...
  context('with `parse`', function() {
    ...
    describe('era', function() {
      ...
      it('narrow', function() {
        var result = parse('44 πΧ', 'y GGGGG', baseDate, {
          locale: locale
        })
    ...
    it('ordinal year', function() {
      var result = parse('2017', 'yo', baseDate, {
        locale: locale
      })
    ...
    describe('quarter', function() {
      it('ordinal', function() {
        var result = parse('1ο', 'Qo', baseDate, {
          locale: locale
        })
      ...
      it('abbreviated', function() {
        var result = parse('Τ3', 'QQQ', baseDate, {
          locale: locale
        })
      ...
      it('wide', function() {
        var result = parse('4ο τριμηνο', 'QQQQ', baseDate, {
          locale: locale
        })
    ...
    describe('month', function() {
      it('ordinal', function() {
        var result = parse('6ος', 'Mo', baseDate, {
          locale: locale
        })
      ...
      it('abbreviated', function() {
        var result = parse('Νοε', 'MMM', baseDate, {
          locale: locale
        })
      ...
      it('narrow', function() {
        var result = parse('Ι', 'MMMMM', baseDate, {
          locale: locale
        })
        assert.deepEqual(result, new Date(1986, 0 /* Jan */, 1))
      })
    ...
    it('ordinal week of year', function() {
      var result = parse('49η', 'wo', baseDate, {
        locale: locale
      })
    ...
    it('ordinal day of month', function() {
      var result = parse('28η', 'do', baseDate, {
        locale: locale
      })
    ...
    it('ordinal day of year', function() {
      var result = parse('200η', 'Do', baseDate, {
        locale: locale
      })
    ...
    describe('day of week', function() {
      it('abbreviated', function() {
        var result = parse('Δευ', 'E', baseDate, {
          locale: locale
        })
      ...
      it('wide', function() {
        var result = parse('Τρίτη', 'EEEE', baseDate, {
          locale: locale
        })
      ...
      it('narrow', function() {
        var result = parse('Δ', 'EEEEE', baseDate, {
          locale: locale
        })
      ...
      it('short', function() {
        var result = parse('Πε', 'EEEEEE', baseDate, {
          locale: locale
        })
    ...
    describe('AM, PM', function() {
      it('abbreviated', function() {
        var result = parse('5 πμ', 'h a', baseDate, {
          locale: locale
        })
      ...
      it('wide', function() {
        var result = parse('5 μμ.', 'h aaaa', baseDate, {
          locale: locale
        })
      ...
      it('narrow', function() {
        var result = parse('11 πμ', 'h aaaaa', baseDate, {
          locale: locale
        })
    ...
    describe('AM, PM, noon, midnight', function() {
      it('abbreviated', function() {
        var result = parse('μεσημερι', 'b', baseDate, {
          locale: locale
        })
      ...
      it('wide', function() {
        var result = parse('μεσάνυχτα', 'bbbb', baseDate, {
          locale: locale
        })
      ...
      it('narrow', function() {
        var result = parse('μεσάνυχτα', 'bbbbb', baseDate, {
          locale: locale
        })
        assert.deepEqual(result, new Date(1986, 3 /* Apr */, 4, 0))
      })
    ...
    describe('flexible day period', function() {
      it('abbreviated', function() {
        var result = parse('2 τη νύχτα', 'h B', baseDate, {
          locale: locale
        })
